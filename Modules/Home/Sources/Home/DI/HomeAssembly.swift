...
public class HomeAssembly: Assembly {
    ...
    public func assemble(container: Container) {
        ...
        container.register(GameRepositoryProtocol.self) { r in
            GameRepository(
                gameApi: r.resolve(GameApiProtocol.self)!,
                favoriteDB: r.resolve(FavoriteGameProvider.self)!
            )
        }
        ...
        container.register(GetGamesUC.self) { r in
            GetGames(
                gameRepository: r.resolve(GameRepositoryProtocol.self)!,
                favoriteRepository: r.resolve(FavoriteRepositoryProtocol.self)!
            )
        }
